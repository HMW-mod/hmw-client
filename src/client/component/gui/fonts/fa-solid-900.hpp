...
// Exported using binary_to_compressed_c.exe -base85 "fa-solid-900.ttf" Fonts
static const char fa_solid_900[308580+1] =
    "7])#######*kK<L'/###[),##-`($#Q6>##kZn42/E`XBx,>>#@tkU%'vA0FI.AI[7s###Y,'##:VPkE-##,^3a&##TtXV$`L@UCiNOBY:SZw0vVp-$f'TqLR^xc;_7I_&XUr-$E3n0F"
    "pt#$><V-R<1j'##Ve$iF/JV?P<;'##0e_w'aM[=BNi.sQQ3i--RJm92/(NDFtxlHGK1C3#n4N7#/c#<GVM05NNs'6#b5h5#p>#BM^YS8%k&Dxf_Uvs'alVP&S9w0#mKe6EmG7Q/#q%M^"
